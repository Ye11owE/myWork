            ...
            public void actionPerformed(ActionEvent e) {
                if (textModeRadioButton.isSelected()){
                    ...
                    if (!isValidBinary(dataInput)) {
                        warning.showMessageDialog(frame, "请输入8位的二进制密文！", "警告", JOptionPane.WARNING_MESSAGE);
                        ...
                        plainText = SDES.decrypt(dataString, key);
                    ...
                    if (dataField.getText().trim().equals("")) {
                        ...
                        for (String block : binaryBlocks) {
                            String plaintextBlock = SDES.decrypt(block, key); // 使用SDES解密
